...
class SignIn extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://backendpractice-production.up.railway.app/signin', {
            method: 'post',
                    ...
                    <form className="measure">
                        ...
                        <div className="">
                            <button
                                ...
                                type="button"><em
                                    className='light-gray'>Sign In</em></button>
                        </div>
                        <div className="lh-copy mt3">
                            <p onClick={() => onRouteChange('register')} className="pointer light-gray f6 link dim db">Register</p>
                        </div>
                    </form>
                </main>
            </article>
